...
var BillModel, BillsCollection, ChartView, ContentLayout, InfoModel, InfoView, MainController, MetaLayout, SearchResults, SearchView, SubjectsModel, SubjectsView, WelcomeView,
...
MainController = (function(_super) {
  ...
  MainController.prototype.showAll = function(billModel, billId) {
    var chartView, contentLayout, metaLayout;
